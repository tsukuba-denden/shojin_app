...
class _EditorScreenState extends State<EditorScreen> {
  ...
  void initState() {
    super.initState();
    // ★★★ _loadSavedCode より前に _codeController を初期化する ★★★
    _codeController = CodeController(
      // language は CodeController に必須だが、表示には影響しない
      language: dart,
      // 初期テキストは _loadSavedCode で設定されるので空でも良い
      // または、一時的なテンプレートを設定しても良い
      text: '// Loading code...',
    );
    _loadSavedCode(); // 保存されたコードを読み込む
  }
